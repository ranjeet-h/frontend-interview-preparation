...
new_tree = """  - [JavaScript Coding Interview Guide](javascript/coding-questions.md)
    ...
    - [Guess the Output: Scope & Hoisting](javascript/coding-questions/16-guess-scope-hoisting.md)
    - [Guess the Output: Closures](javascript/coding-questions/17-guess-closures.md)
    - [Guess the Output: `this`](javascript/coding-questions/18-guess-this.md)
    - [Guess the Output: Equality & Coercion](javascript/coding-questions/19-guess-coercion.md)
    - [Guess the Output: Types & Keys](javascript/coding-questions/20-guess-types.md)
    - [Guess the Output: Objects & References](javascript/coding-questions/21a-guess-objects-arrays.md)
    - [Guess the Output: Array Methods & Sort](javascript/coding-questions/21b-guess-objects-arrays.md)
    - [Guess the Output: Prototypes & Classes](javascript/coding-questions/22-guess-prototypes-classes.md)
    - [Guess the Output: async/await & Chains](javascript/coding-questions/23-guess-promises.md)
    - [Guess the Output: Event Loop](javascript/coding-questions/24-guess-event-loop.md)
    - [Guess the Output: Operators & Functions](javascript/coding-questions/25a-guess-misc.md)
    - [Guess the Output: Descriptors & Misc](javascript/coding-questions/25b-guess-misc.md)
    - [Debugging Challenges](javascript/coding-questions/26-debugging.md)
