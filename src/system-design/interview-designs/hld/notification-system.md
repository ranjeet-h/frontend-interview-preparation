...
For a longer real-time and connection-oriented discussion, see the existing [distributed notification service deep dive](../../backend-designs/design-a-distributed-notification-service.md).
