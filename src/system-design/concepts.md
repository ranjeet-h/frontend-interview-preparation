...
3. Move to [Easy examples](examples/easy/index.md) only after you can do that for most of this list.

Question numbering is continuous across the Examples section: **Easy 1–20**, **Medium 21–55**, **Hard 56–80**, **Very hard 81–85**. Each problem appears on exactly one page.

Several classics also have a deeper standalone page under [Backend System Design](backend-designs/index.md) — linked from the chapter banks where applicable.
