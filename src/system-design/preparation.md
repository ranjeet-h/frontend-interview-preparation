...
| **3–4** | [Easy examples](examples/easy/index.md) — shortener, cache, auth, email, session, file upload | You finish a full easy prompt in 35–40 minutes with a diagram |
| **5–7** | [Medium examples](examples/medium/index.md) — feeds, chat, payments, search | You identify fanout, cache, and async work without prompting |
| **8–10** | [Hard examples](examples/hard/index.md) — global scale, transactions, geo | You handle "what breaks at 100×" follow-ups calmly |
| **11–12** | Mocks + [Very hard examples](examples/very-hard/index.md) skim | Timed 45–60 min sessions; record and review |
...
**Reference while studying:** [Backend System Design](backend-designs/index.md) for full-depth classics (URL shortener, auth, payments, feeds).
